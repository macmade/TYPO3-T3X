<?php
	...
	class tx_sendpage_handleBeUsers {
	
		/**
		 * Adds BE-Users to selector box items arrays.
		 * Adds ALL available BE-Users, depending of the group(s) of the current user.
		 *
		...
		function main(&$params,&$pObj) {
			...
			$be_users = t3lib_BEfunc::getRecordsByField('be_users','deleted','0',$addWhere,'','realName');
	...
	// XCLASS inclusion
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/sendpage/class.tx_sendpage_handlebeusers.php']) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/sendpage/class.tx_sendpage_handlebeusers.php']);
	}
?>
