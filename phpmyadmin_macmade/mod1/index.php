...
$LANG->includeLLFile( 'EXT:phpmyadmin_macmade/lang/mod1.xml' );
...
require_once( t3lib_extMgm::extPath( 'phpmyadmin_macmade' ) . 'mod1/class.tx_phpmyadminmacmade_module1.php' );

// Creates the module instance
$SOBE = t3lib_div::makeInstance( 'tx_phpmyadminmacmade_module1' );
