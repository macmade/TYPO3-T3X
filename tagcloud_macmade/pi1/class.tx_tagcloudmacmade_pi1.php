<?php
	...
	/** 
	 * Plugin 'TagCloud / macmade.net' for the 'tagcloud_macmade' extension.
	 *
	...
	class tx_tagcloudmacmade_pi1 extends tslib_pibase {
		...
		// Same as class name
		var $prefixId = 'tx_tagcloudmacmade_pi1';
		
		// Path to this script relative to the extension dir
		var $scriptRelPath = 'pi1/class.tx_tagcloudmacmade_pi1.php';
		
		// The extension key
		var $extKey = 'tagcloud_macmade';
		 ...
		 * 
		 * This function initialises the plugin "tx_tagcloudmacmade_pi1", and
	 ...
	 * XCLASS inclusion
	 */
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tagcloud_macmade/pi1/class.tx_tagcloudmacmade_pi1.php']) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/tagcloud_macmade/pi1/class.tx_tagcloudmacmade_pi1.php']);
	}
?>
