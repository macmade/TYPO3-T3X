 ...
 * @subpackage  oop
 */
abstract class tx_oop_pluginBase extends tslib_pibase
{
    /**
     * The method used to get the plugin content, which has to be declared
     * in the child classes
     */
    abstract protected function _getPluginContent( tx_oop_xhtmlTag $content );
    ...
    public function __construct()
    {
        ...
        $this->_lang = tx_oop_lang::getInstance( 'EXT:' . $this->_extKey . '/lang/pi' . $this->_moduleNumber . '.xml' );
