 ...
 * @subpackage  oop
 */
abstract class tx_oop_Tca_Field
{
    /**
     ...
     * Class constructor
     * 
     * @param   tx_oop_Tca_Table    The TCA table object in which the current field is registered
     * @param   string              The field name
     */
    public function __construct( tx_oop_Tca_Table $table, $name )
    {
