 ...
 * @subpackage  oop
 */
class tx_oop_Xhtml_Tag implements ArrayAccess, Iterator
{
    /**
     ...
     * 
     * @return  tx_oop_Xhtml_Tag    The current HTML tag object
     */
    ...
    protected function _addComment( $text )
    {
        ...
        $comment             = new tx_oop_Xhtml_Comment( $text );
     ...
     * 
     */
    public function addChildNode( tx_oop_Xhtml_Tag $child )
    {
