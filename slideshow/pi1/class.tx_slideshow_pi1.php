<?php
	 ...
	 *     171:		function buildFlashCode
	 *     207:		function writeFlashObjectParams
	 * 
	 *				TOTAL FUNCTIONS: 4
	 */
	...
	class tx_slideshow_pi1 extends tslib_pibase {
		...
		// Same as class name
		var $prefixId = 'tx_slideshow_pi1';
		
		// Path to this script relative to the extension dir
		var $scriptRelPath = 'pi1/class.tx_slideshow_pi1.php';
		
		// The extension key
		var $extKey = 'slideshow';
		
		// Upload directory
		var $uploadDir = 'uploads/tx_slideshow/';
		...
		function buildFlashCode() {
			...
			$xmlFile = 'index.php?id=' . $GLOBALS['TSFE']->id . '&type=' . $this->conf['xmlPageId'] . '&slideshow=' . $this->conf['slideshow'] . '&random=' . $this->conf['playerParams.']['random'] . '&transition=' . $this->conf['playerParams.']['transition'] . '&timer=' . $this->conf['playerParams.']['timer'] . '&navigation=' . $this->conf['playerParams.']['navigation'];
	 ...
	 * XCLASS inclusion
	 */
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/slideshow/pi1/class.tx_slideshow_pi1.php']) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/slideshow/pi1/class.tx_slideshow_pi1.php']);
	}
?>
