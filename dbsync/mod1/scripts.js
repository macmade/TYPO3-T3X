<!--
	 ...
	 * 
	 * SECTION:		1 - MAIN
	 *      76:		function setRowColor(row,color)
	 *      90:		function enableRadio(id)
	 *     113:		function setRowColorCheck(row,id,action,color1,color2)
	 *     174:		function checkBoxList(field)
	 * 
	 * 				TOTAL FUNCTIONS: 4
	 */
	 ...
	 * The color will depend of the given action.
	 * 
	 ...
	 * 
	 * This function enables or disables a radio button.
	 * 
	...
	/**
	 * Change row bgColor and enable checkbox.
	 * 
	 * This function change the background color for the specified row.
	 * The color will depend of the given action (rollover or click).
	 * The associated checkbox will also be enabled.
	 * 
	 * @param		row					The row to process
	 * @param		id					The row id
	 ...
	 * @return		Void
	 */
	function setRowColorCheck(row,id,action,color1,color2) {
