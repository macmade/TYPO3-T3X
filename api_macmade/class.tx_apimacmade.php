<?php
	 ...
	 * 
	 * SECTION:		1 - INTERNAL
	 *     166:		function tx_apimacmade(&$pObj)
	 *     193:		function versionError($version=false)
	 *     231:		function errorMsg($funcId)
	 * 
	 * SECTION:		2 - FE
	 *     279:		function fe_mergeTSconfFlex($mapArray,$tsArray,$flexRes)
	 *     336:		function fe_initTemplate($templateFile)
	 *     356:		function fe_renderTemplate($templateMarkers,$templateSection)
	 *     394:		function fe_makeStyledContent($element,$className,$content=false,$piClass=1,$htmlSpecialChars=false,$startTagOnly=false,$params=array())
	 *     461:		function fe_setInternalVars($results_at_a_time=false,$maxPages=false,$searchFieldList=false,$orderByList=false)
	 *     503:		function fe_buildSwapClassesJSCode($class1,$class2)
	 *     553:		function fe_makeSwapClassesJSLink($elementId,$content=false,$htmlSpecialChars=false,$startTagOnly=false,$params=array())
	 *     604:		function fe_createImageObjects($imgRefs,$conf,$imgPath=false)
	 *     657:		function fe_linkTP($str,$urlParameters=array(),$cache=0,$altPageId=0,$conf=array())
	 *     694:		function fe_linkTP_unsetPIvars($str,$overrulePIvars=array(),$unsetPIvars=array(),$cache=0,$clearAnyway=0,$altPageId=0)
	 *     738:		function fe_linkTP_unsetPIvars_url($overrulePIvars=array(),$unsetPIvars=array(),$cache=0,$clearAnyway=0,$altPageId=0)
	 *     788:		function fe_initFeAdmin($conf,$table,$pid,$feAdminConf,$create=1,$edit=0,$delete=0,$infomail=0,$fe_userOwnSelf=0,$fe_userEditSelf=0,$debug=0,$defaultCmd='create',$confKey='fe_adminLib')
	 *     895:		function fe_createInput($type,$name,$feAdminConf,$feAdminSection,$number=1,$params=array(),$defaultValue=0,$defaultChecked=0,$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />')
	 *    1042:		function fe_createTextArea($name,$feAdminConf,$feAdminSection,$params=array(),$defaultValue=0,$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />')
	 *    1121:		function fe_createSelect($name,$feAdminConf,$feAdminSection,$options,$htmlspecialchars=1,$params=array(),$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />') {
	 *    1249:		function fe_createSelectFromTable($name,$feAdminConf,$feAdminSection,$table,$pidList,$labelField,$valueField='uid',$htmlspecialchars=1,$addWhere='',$groupBy='',$orderBy='',$limit='',$params=array(),$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />') {
	 *    1363:		function fe_buildFormElementHeader($name,$langPrefix,$headerSeparation,$requiredFieldList=false,$evalValues=array())
	 *    1422:		function fe_buildLoginBox($pid,$inputSize='30',$method='POST',$target='_self',$wrap=false,$layout=false,$langPrefix='pi_loginbox_',$permaLogin=false)
	 *    1593:		function fe_buildSearchBox($method='post',$nocache=true,$sword='sword',$pointer='pointer')
	 *    1647:		function fe_buildBrowseBox($pointer='pointer',$count='res_count',$maxResults='results_at_a_time',$maxPages='maxPages')
	 * 
	 * SECTION:		3 - BE
	 *    1744:		function be_buildRecordIcons($actions,$table,$uid)
	 *    1802:		function be_buildPageTreeSelect($name,$treeStartingPoint=0,$size='1',$multiple=false,$pageIcons=1)
	 *    1874:		function be_getSelectStyleRecordIcon($table,$rec,$backPath)
	 *    1909:		function be_initCSM
	 *    1936:		function be_getRecordCSMIcon($table,$rec,$backPath,$align='top')
	 * 
	 * SECTION:		4 - DB
	 *    1981:		function db_table2text($table,$fieldList='*',$addWhere='',$groupBy='',$orderBy='',$limit='',$sepField=chr(9),$sepRow=chr(10)
	 *    2038:		function db_table2xml($table,$fieldList='*',$whereClause='',$groupBy='',$orderBy='',$limit='',$uppercase=1,$xmlDeclaration=1,$xmlVersion='1.0',$xmlEncoding='iso-8859-1',$directOut=0,$ns='',$nsPrefix='ns')
	 * 
	 * SECTION:		5 - DIV
	 *    2170:		function div_utf8ToIso($content)
	 *    2197:		function div_getAge($tstamp,$currentTime=false,$ageType=false)
	 *    2249:		function div_writeTagParams($params)
	 *    2291:		function div_checkVarType($vars,$type='array')
	 *    2343:		function div_cleanArray($input,$keys,$inverse=0)
	 *    2398:		function div_baseURL($url,$http=1,$trailingSlash=1)
	 *    2492:		function div_vCardCreate($user,$version='3.0',$charset=false)
	 *    2711:		function div_vCardFileParse($file)
	 *    3273:		function div_str2list($string,$sep=',',$htmlspecialchars=1,$listType='ul',$listParams=array(),$itemsParams=array())
	 *    3320:		function div_array2list($array,$htmlspecialchars=1,$listType='ul',$listParams=array(),$itemsParams=array())
	 *    3371:		function div_output($out,$cType,$fName,$cDisp='attachment',$charset='utf-8')
	 *    3412:		function div_xml2array($data,$keepAttribs=1,$caseFolding=0,$skipWhite=0,$prefix=false,$numeric='n',$index='index',$type='type',$base64='base64',$php5defCharset='iso-8859-1')
	 *    3671:		function div_array2xml($input,$xmlRoot='phpArray',$prefix='',$numeric='item',$numericAsAttribute='index',$addArrayAttribute='type',$xmlDeclaration=1,$encoding='iso-8859-1',$version='1.0',$standalone='yes',$doctype=false,$newLine=10,$indent=9,$level=0)
	 *    3912:		function div_crop($str,$chars,$endString='...',$crop2space=1,$stripTags=1)
	 *    3966:		function div_week2date($day,$week,$year)
	 *    4061:		function div_numberInRange($number,$min,$max,$int=false)
	 *    4105:		function div_rgb2hsl($R,$G,$B,$round=1)
	 *    4226:		function div_hsl2rgb($H,$S,$L,$round=1)
	 *    4367:		function div_rgb2hsv($R,$G,$B,$round=1)
	 *    4479:		function div_hsv2rgb($H,$S,$V,$round=1)
	 *    4599:		function div_hsl2hsv($H,$S,$L,$round=1)
	 *    4627:		function div_hsv2hsl($H,$S,$V,$round=1)
	 *    4658:		function div_createHexColor($v1,$v2,$v3,$method='RGB',$uppercase=1)
	 *    4728:		function div_modifyHexColor($color,$v1,$v2,$v3,$methid='RGB',$uppercase=1)
	 *    4796:		function div_formatXHTML($xhtml,$uppercase=0,$newLine=10,$indent=9,$level=0)
	 *    4916:		function div_convertLineBreaks($text,$stripNull=1)
	 *    4956:		function div_checkArrayKeys($array,$keys,$allowEmpty=false,$checkType)
	 *    5024:		function div_rmdir($path,$relative=0,$cleaned=false)
	 *    5136:		function div_isType($var,$type)
	 * 
	 * SECTION:		6 - DEBUG
	 *    5191:		function viewArray($array,$indent=0)
	 *    5289:		function debug($variable,$header='DEBUG')
	 * 
	 *				TOTAL FUNCTIONS: 60
	 */
	...
	class tx_apimacmade {
		 ...
		 * When you call the constructor, do not forget to set the $apimacmade_version
		 * class variable, as it will be used for version checking of the API.
		 * 
		...
		function tx_apimacmade(&$pObj) {
			...
			if (isset($pObj->apimacmade_version) && $pObj->apimacmade_version <= $this->version) {
				...
				die($this->versionError($pObj->apimacmade_version));
			}
		}
		 ...
		 * 
		 * This function produce the error message if the version of the
		 * API is too old.
		 * 
		 * @param		$version	The required version of the API
		 * @return		An HTML page with the error message
		 */
		function versionError($version=false) {
			...
			$htmlCode[] = '<title>Error</title>';
			$htmlCode[] = '</head>';
			$htmlCode[] = '<body>';
			$htmlCode[] = '<div align="center" style="color: #666666; font-size: 12px; font-family: Verdana,Arial,Helvetica; padding: 5px; border: solid 1px #660000; background: #E7CECE; margin: 10px">';
			$htmlCode[] = '<p><h1>Typo3 Developer API error:</strong></h1>';
			$htmlCode[] = '<p>The version of Typo3 Developer API you are trying to use is too old. Please update to the required version.</p>';
			$htmlCode[] = '<hr align="center" noshade size="1" width="50%">';
			$htmlCode[] = '<p><strong>Loaded version: ' . $this->version . '<br>Required version: ' . $version . '</strong></p>';
			$htmlCode[] = '</div>';
			$htmlCode[] = '</body>';
			$htmlCode[] = '</html>';
		 ...
		 * 
		 * @param		$function	The ID/name of the function
		 * @return		Void
		 */
		function errorMsg($function) {
			...
			$htmlCode[] = '<div align="center" style="color: #666666; font-size: 12px; font-family: Verdana,Arial,Helvetica; padding: 5px; border: solid 1px #660000; background: #E7CECE; margin: 10px">';
			$htmlCode[] = '<p><h1>Typo3 Developer API error:</strong></h1>';
			$htmlCode[] = '<p>The function <pre>' . $function . '</pre> reported an error. Please check the arguments you passed to that function in order to solve the problem.</p>';
			$htmlCode[] = '</div>';
			
			// Return error message
			echo(implode(chr(10),$htmlCode));
		}
		 ...
		 * 
		 * @param		$mapArray			The mapping array with informations about values to replace
		 * @param		$tsArray			The initial TS configuration array
		 * @param		$flexRes			The flexform object (usually $this->pObj->cObj->data['pi_flexform'])
		 * @return		The merged configuration array
		 */
		function fe_mergeTSconfFlex($mapArray,$tsArray,$flexRes) {
			
			// Function ID
			$funcId = 'fe_mergeTSconfFlex';
			
			// Check for valid arguments
			if ($this->div_checkVarType(array($mapArray,$tsArray))) {
				...
				foreach($mapArray as $key=>$value) {
					...
					if (is_array($value)) {
						...
						$tempConfig[$key] = $this->fe_mergeTSconfFlex($value,$tsArray[$key],$flexRes);
						...
						$flexValue = (string) $this->pObj->pi_getFFvalue($flexRes, $flexInfo[1], $flexInfo[0]);
		...
		function fe_renderTemplate($templateMarkers,$templateSection) {
			...
			// Function ID
			$funcId = 'fe_renderTemplate';
			
			// Check arguments and if template is loaded
			if ($this->templateContent && is_array($templateMarkers)) {
				
				// Get template subparts
				$subpart = $this->pObj->cObj->getSubpart($this->templateContent,$templateSection);
				
				// Return substituted section
				return $this->pObj->cObj->substituteMarkerArrayCached($subpart,array(),$templateMarkers,array());
		 ...
		 * 
		 * @param		$element			The HTML element to produce
		 * @param		$className			The CSS class name to link
		 * @param		$content			The content to wrap
		 * @param		$piClass			Prepends class name with plugin name (using pi_classParam)
		 * @param		$htmlSpecialChars	Pass the content through htmlspecialchars()
		 * @param		$startTagOnly		Generate only the starting tag (without content!)
		 * @param		$params				The parameters of the HTML element as key/value pairs
		...
		function fe_makeStyledContent($element,$className,$content=false,$piClass=1,$htmlSpecialChars=false,$startTagOnly=false,$params=array()) {
			...
			if (is_array($params)) {
				...
				if ($startTagOnly) {
					...
					$styledContent = ($content) ? '<' . $startTag . '>' . $content . '</' . $element . '>' : '<' . $startTag . ' />';
		 ...
		 * 
		 * @param		$results_at_a_time	The maximum number of records to display in a list view
		 * @param		$maxPages			The maximum number of pages to display in the browsebox
		 * @param		$searchFieldList	The fields available for searching
		 * @param		$orderByList		The fields available to use as ORDER BY parameter
		 * @return		Void
		 */
		function fe_setInternalVars($results_at_a_time=false,$maxPages=false,$searchFieldList=false,$orderByList=false) {
			
			// Function ID
			$funcId = 'fe_setInternalVars';
			
			// Check arguments
			if (is_array($this->pObj->internal)) {
				
				// MySQL ORDER BY parameter
				list($this->pObj->internal['orderBy'],$this->pObj->internal['descFlag']) = explode(':',$this->pObj->piVars['sort']);
		 ...
		 * @param		$changeIcon			If this is set, the JS code will also change the source of an icon. This variable must be an array, with "plus" and "minus" as keys, containing the path for the icons.
		 * @param		$iconSuffix			The suffix for the icon ID
		 * @return		Void
		 */
		function fe_buildSwapClassesJSCode($class1,$class2,$changeIcon=false,$iconSuffix='_pic') {
			
			// Function ID
			$funcId = 'fe_buildSwapClassesJSCode';
			
			// Storage
			$jsCode = array();
			
			// Function for swapping element class
			$jsCode[] = 'function ' . $this->pObj->prefixId . '_swapClasses(element) {';
			$jsCode[] = '	if (document.getElementById) {';
			$jsCode[] = '		document.getElementById(element).className = (document.getElementById(element).className == "' . $class1 . '") ? "' . $class2 . '" : "' . $class1 . '";';
			
			// Check if an icon must be changed
			if (is_array($changeIcon) && array_key_exists('minus',$changeIcon) && array_key_exists('plus',$changeIcon)) {
				...
				// Add icon change
				$jsCode[] = '		icon = element + "' . $iconSuffix . '";';
				$jsCode[] = '		document.getElementById(icon).src = (document.getElementById(element).className == "' . $class1 . '") ? "' . $minus . '" : "' . $plus . '";';
			}
			...
			// Adds JS code
			$GLOBALS["TSFE"]->setJS($this->pObj->prefixId,implode(chr(10),$jsCode));
		}
		 ...
		 * 
		 * @param		$elementId			The ID of the HTML element to change
		 * @param		$content			The content to wrap
		 * @param		$htmlSpecialChars	Pass the content through htmlspecialchars()
		 * @param		$startTagOnly		Generate only the starting tag (without content!)
		 * @param		$params				The attributes of the HTML element as key/value pairs
		 * @return		The swap classes link
		 * @see			div_cleanArray
		 * @see			div_writeTagParams
		 */
		function fe_makeSwapClassesJSLink($elementId,$content=false,$htmlSpecialChars=false,$startTagOnly=false,$params=array()) {
			...
			// Function ID
			$funcId = 'fe_makeSwapClassesJSLink';
			...
			if (is_array($params)) {
				...
				// Create start tag
				$startTag = '<a href="javascript:' . $this->pObj->prefixId . '_swapClasses(\'' . $elementId . '\');" ' . $this->div_writeTagParams($params) . '>';
		 ...
		 * in a database field.
		 * 
		 * @param		$imgRefs			A comma list of picture names
		 * @param		$conf				The TS setup for the images
		 * @param		$imgPath			The path of the images (will be prepended to each picture name)
		 * @return		An IMAGE cObject for each picture
		 */
		function fe_createImageObjects($imgRefs,$conf,$imgPath=false) {
			
			// Function ID
			$funcId = 'fe_createImageObjects';
		 ...
		 *
		 * @param		$str				The content string to wrap in <a> tags
		 * @param		$urlParameters		Array with URL parameters as key/value pairs. They will be "imploded" and added to the list of parameters defined in the plugins TypoScript property "parent.addParams" plus $this->pi_moreParams
		 * @param		$cache				If $cache is set (0/1), the page is asked to be cached by a &cHash value (unless the current plugin using this class is a USER_INT). Otherwise the no_cache-parameter will be a part of the link
		 * @param		$altPageId			Alternative page ID for the link (by default this function links to the SAME page!)
		 * @param		$conf				An optionnal array for the typolink configuration
		 * @return		The input string wrapped in <a> tags
		 */
		function fe_linkTP($str,$urlParameters=array(),$cache=0,$altPageId=0,$conf=array()) {
			...
			$conf['additionalParams'] = $this->pObj->conf['parent.']['addParams'] . t3lib_div::implodeArrayForUrl('',$urlParameters,'',1) . $this->pObj->pi_moreParams;
		 ...
		 * 
		 * @param		$str				The content string to wrap in <a> tags
		 * @param		$overrulePIvars		Array of values to override or add in the current piVars
		 * @param		$unsetPIvars		Array of values not to include in the current piVars
		 * @param		$cache				Ask the page to be cached by a &cHash value
		 * @param		$clearAnyway		Do not preserve current piVars
		 * @param		$altPageId			Alternative page ID for the link
		 * @return		The input string wrapped in <a> tags
		 */
		function fe_linkTP_unsetPIvars($str,$overrulePIvars=array(),$unsetPIvars=array(),$cache=0,$clearAnyway=0,$altPageId=0) {
			
			// Function ID
			$funcId = 'fe_linkTP_unsetPIvars';
			
			// Check arguments
			if ($this->div_checkVarType(array($overrulePIvars,$unsetPIvars))) {
				
				// Check for unsetPIvars array
				if (is_array($unsetPIvars) && count($unsetPIvars)) {
				...
				// Returns link
				return $this->pObj->pi_linkTP_keepPIvars($str,$overrulePIvars,$cache,$clearAnyway,$altPageId);
		...
		function fe_linkTP_unsetPIvars_url($overrulePIvars=array(),$unsetPIvars=array(),$cache=0,$clearAnyway=0,$altPageId=0) {
			...
			// Function ID
			$funcId = 'fe_linkTP_unsetPIvars_url';
			...
			if ($this->div_checkVarType(array($overrulePIvars,$unsetPIvars))) {
				...
				// Returns link
				return $this->pObj->pi_linkTP_keepPIvars_url($overrulePIvars,$cache,$clearAnyway,$altPageId);
		 ...
		 * 
		 * @param		$conf				The plugin configuration array
		 * @param		$table				The table to use
		 * @param		$pid				The pid for the records
		 * @param		$feAdminConf		The configuration array for fe_adminLib subparts
		 * @param		$create				Create capabilities (Boolean)
		 * @param		$edit				Edit capabilities (Boolean)
		 * @param		$delete				Delete capabilities (Boolean)
		 * @param		$infomail			Infomail capabilities (Boolean)
		 * @param		$fe_userOwnSelf		FE-Users own themselves (Boolean)
		 * @param		$fe_userEditSelf	FE-Users can edit themselves (Boolean)
		 * @param		$debug				Output debug informations (Boolean)
		 * @param		$defaultCmd			The default command to use if none is found
		 * @param		$confKey			The key to use for fe_adminLib in the plugin configuration array
		 * @return		The complete plugin configuration array with a valid fe_adminLib configuration
		 */
		function fe_initFeAdmin($conf,$table,$pid,$feAdminConf,$create=1,$edit=0,$delete=0,$infomail=0,$fe_userOwnSelf=0,$fe_userEditSelf=0,$debug=0,$defaultCmd='create',$confKey='fe_adminLib') {
			...
			// Function ID
			$funcId = 'fe_initFeAdmin';
			
			// Check arguments
			if ($this->div_checkVarType(array($conf,$feAdminConf))) {
		 ...
		 * @param		$feAdminConf		The fe_adminLib configuration array
		 * @param		$feAdminSection		The fe_adminLib section (usually create or edit) - Used to check for required fields
		 * @param		$number				The number of imput to create
		 * @param		$params				The input tag parameters (depending of context) as an array with key/value pairs
		 * @param		$defaultValue		The default value for the input. Can be an array for multiple inputs, or 'unix' for checkboxes/radios with unix-perms like values (eg. 1 -2 - 4 - 8, etc.), or 'increment' for incrementing values (eg. 0 - 1 -2 - 3, etc.)
		 * @param		$defaultChecked		For checkboxes or radios, if the input must be checked by default. Can be a comma list for multiple checkboxes
		 * @param		$keepSentValues		Keep element value if the form is redrawn (will override default value or default checked)
		 * @param		$langPrefix			The prefix for the plugin locallangfile. Used to fetch the title of the input and the warning message, if applicable
		 * @param		$headerSeparation	The separation between the title and the input
		 * @return		A complete form element, with title, warning, and the input itself
		...
		function fe_createInput($type,$name,$feAdminConf,$feAdminSection,$number=1,$params=array(),$defaultValue=0,$defaultChecked=0,$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />') {
			...
			// Function ID
			$funcId = 'fe_createInput';
			
			// Check arguments
			if ($this->div_checkVarType(array($feAdminConf,$params))) {
				...
				if ($type != 'submit') {
					...
					$htmlCode[] = $this->fe_buildFormElementHeader($name,$langPrefix,$headerSeparation,$feAdminConf[$feAdminSection . '.']['required'],$feAdminConf[$feAdminSection . '.']['evalValues.']);
				}
				...
				for ($i = 0; $i < $number; $i++) {
					...
					} else if ($defaultValue && $defaultValue == 'unix') {
						
						// Unix like values
						$currentValue = pow(2,$i);
						
					} else if ($defaultValue && $defaultValue == 'increment') {
						
						// Increment values
						$currentValue = $i;
						
					} else if ($keepSentValues && $fieldValue) {
					...
					// Create input
					$htmlCode[] = '<input type="' . $type . '" name="' . $feAdminName . '" ' . $this->div_writeTagParams($params) . '>';
				}
		 ...
		 * @param		$feAdminConf		The fe_adminLib configuration array
		 * @param		$feAdminSection		The fe_adminLib section (usually create or edit) - Used to check for required fields
		 * @param		$params				The textarea tag parameters as an array with key/value pairs
		 * @param		$defaultValue		The default value for the textarea
		 * @param		$keepSentValues		Keep element value if the form is redrawn (will override default value)
		 * @param		$langPrefix			The prefix for the plugin locallangfile. Used to fetch the title of the textarea and the warning message, if applicable
		 * @param		$headerSeparation	The separation between the title and the textarea
		 * @return		A complete textarea zone, with title and warning.
		 * @see			div_cleanArray
		...
		function fe_createTextArea($name,$feAdminConf,$feAdminSection,$params=array(),$defaultValue=0,$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />') {
			...
			if ($this->div_checkVarType(array($feAdminConf,$params))) {
				...
				// Create textarea
				$htmlCode[] = '<textarea name="' . $feAdminName . '" ' . $this->div_writeTagParams($params) . '>' . $value . '</textarea>';
		 ...
		 * @param		$htmlspecialchars	Pass the option labels through htmlspecialchars()
		 * @param		$params				The select tag parameters as an array with key/value pairs
		 * @param		$keepSentValues		Keep element value if the form is redrawn
		 * @param		$langPrefix			The prefix for the plugin locallangfile. Used to fetch the title of the select and the warning message, if applicable
		 * @param		$headerSeparation	The separation between the title and the select
		 * @return		A complete select, with title and warning.
		 * @see			div_cleanArray
		 * @see			buildFormElementHeader
		 * @see			div_writeTagParams
		 */
		function fe_createSelect($name,$feAdminConf,$feAdminSection,$options,$htmlspecialchars=1,$params=array(),$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />') {
			...
			if ($this->div_checkVarType(array($feAdminConf,$params))) {
				...
				// Start select
				$htmlCode[] = '<select name="' . $feAdminName . '" ' . $this->div_writeTagParams($params) . '>';
				...
				if (is_array($options)) {
					...
					for ($i = 0; $i < $options; $i++) {
						...
						// Add option
						$htmlCode[] = '<option value="' . $i . '"' . $selected . '>' . $this->pObj->pi_getLL($langPrefix . $name . '.I.' . $i,'[item' . $i . ']') . '</option>';
					}
				}
		 ...
		 * @param		$feAdminConf		The fe_adminLib configuration array
		 * @param		$feAdminSection		The fe_adminLib section (usually create or edit) - Used to check for required fields
		 * @param		$table				The table containing the records (must be a valid Typo3 table)
		 * @param		$pidList			The pages from where to select the records (as a comma list)
		 * @param		$labelField			The field in the database to use as option label
		 * @param		$valueField			The field in the database to use as option value (usually UID)
		 * @param		$htmlspecialchars	Pass the option labels through htmlspecialchars()
		 * @param		$addWhere			Optional additional WHERE clauses put in the end of the query. DO NOT PUT IN GROUP BY, ORDER BY or LIMIT!
		 ...
		 * @param		$params				The select tag parameters as an array with key/value pairs
		 * @param		$keepSentValues		Keep element value if the form is redrawn
		 * @param		$langPrefix			The prefix for the plugin locallang file. Used to fetch the title of the select and the warning message, if applicable
		 * @param		$headerSeparation	The separation between the title and the select
		 * @return		A complete select, with title and warning.
		 * @see			div_cleanArray
		 * @see			buildFormElementHeader
		...
		function fe_createSelectFromTable($name,$feAdminConf,$feAdminSection,$table,$pidList,$labelField,$valueField='uid',$htmlspecialchars=1,$addWhere='',$groupBy='',$orderBy='',$limit='',$params=array(),$keepSentValues=1,$langPrefix='pi_feadmin_',$headerSeparation=':<br />') {
			...
			// Function ID
			$funcId = 'fe_createSelectFromTable';
			...
			if ($this->div_checkVarType(array($feAdminConf,$params))) {
				...
				$options = $this->pObj->pi_getCategoryTableContents($table,$mainPid,implode(' ',$whereClause),$groupBy,$orderBy);
				...
				if (is_array($options)) {
					...
					foreach($options as $row) {
						...
						// Add option
						$htmlCode[] = '<option value="' . $row[$valueField] . '"' . $selected . '>' . $value . '</option>';
		 ...
		 * @param		$langPrefix			The prefix to use to get the field title in the locallang file
		 * @param		$headerSeparation	The separation to use between the header and the form element
		 * @param		$requiredFieldList	A comma list of the required fields of the feAdmin section
		 * @param		$evalValues			The evalValues array from the feAdmin configuration array
		...
		function fe_buildFormElementHeader($name,$langPrefix,$headerSeparation,$requiredFieldList=false,$evalValues=array()) {
			...
			// Function ID
			$funcId = 'fe_buildFormElementHeader';
			...
			if ($eval) {
				...
				$header[] = '<!--###SUB_REQUIRED_FIELD_' . $name . '###-->';
				$header[] = '<br /><strong>' . $this->pObj->pi_getLL($langPrefix . $name . '_evalerror','Error with the data type') . '</strong><br />';
				$header[] = '<!--###SUB_REQUIRED_FIELD_' . $name . '###-->';
				...
				// Field is required
				$header[] = '<!--###SUB_REQUIRED_FIELD_' . $name . '###-->';
				$header[] = '<br /><strong>' . $this->pObj->pi_getLL($langPrefix . $name . '_required','Error: the field is required') . '</strong><br />';
				$header[] = '<!--###SUB_REQUIRED_FIELD_' . $name . '###-->';
			}
		 ...
		 * 
		 * @param		$pid				The PID of the sysfolder containing the frontend users allowed to login
		 * @param		$inputSize			The size of the inputs to generate
		 * @param		$method				The method of the form object used for sending variables
		 * @param		$target				The target of the form object
		 * @param		$wrap				Wrap the whole object
		 * @param		$layout				The layout of the form object
		 * @param		$langPrefix			The prefix to use to get the field title in the locallang file
		 * @param		$permaLogin			Show permalogin option (needs extension 'core_permalogin')
		 * @return		A login box
		...
		function fe_buildLoginBox($pid,$inputSize='30',$method='POST',$target='_self',$wrap=false,$layout=false,$langPrefix='pi_loginbox_',$permaLogin=false) {
			...
			// Set default layout
			if (!$layout) {
				$layout = '<tr>' . $this->fe_makeStyledContent('td','labelCell','###LABEL###',1,false,false,array('width'=>'25%','align'=>'left','valign'=>'middle')) . $this->fe_makeStyledContent('td','fieldCell','###FIELD###',1,false,false,array('width'=>'75%','align'=>'left','valign'=>'top')) . '</tr>';
			}
			
			// Set default wrap
			if (!$wrap) {
				$wrap = $this->fe_makeStyledContent('table','loginTable','|',1,false,false,array('border'=>'0','width'=>'100%','align'=>'center','cellspacing'=>'0','cellpading'=>'0'));
			}
			...
			if ($GLOBALS['TSFE']->loginUser) {
				...
				if ($permaLogin && t3lib_extMgm::isLoaded('core_permalogin')) {
					...
					$permaConf = unserialize($GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf']['core_permalogin']);
		 ...
		 * 
		 * @param		$method				The method for the search form (get or post)
		 * @param		$nocache			Add a no cache flag
		 * @param		$sword				The sword variable in piVars
		 * @param		$pointer			The pointer variable in piVars
		 * @return		A search box
		 * @see			fe_makeStyledContent
		 */
		function fe_buildSearchBox($method='post',$nocache=true,$sword='sword',$pointer='pointer') {
			...
			// Header
			$htmlCode[] = $this->fe_makeStyledContent('h2','searchbox-header',$this->pObj->pi_getLL('searchbox.header','Search'));
			
			// Start form
			$htmlCode[] = $this->fe_makeStyledContent('form','searchform',false,1,0,1,array('action'=>htmlspecialchars(t3lib_div::getIndpEnv('REQUEST_URI')),'enctype'=>$GLOBALS['TYPO3_CONF_VARS']['SYS']['form_enctype'],'method'=>$method));
			
			// Search word
			$htmlCode[] = $this->fe_makeStyledContent('input',$sword,false,1,0,0,array('type'=>'text','name'=>$this->pObj->prefixId . '[' . $sword . ']','value'=>$swordValue));
			
			// Submit
			$htmlCode[] = $this->fe_makeStyledContent('input','submit',false,1,0,0,array('type'=>'submit','value'=>$this->pObj->pi_getLL('searchbox.submit','Submit')));
			...
			// Pointer
			$htmlCode[] = '<input name="' . $this->pObj->prefixId . '[' . $pointer . ']' . '" type="hidden" value="" />';
			
			// End form
			$htmlCode[] = '</form>';
			
			// Return code
			return  $this->fe_makeStyledContent('div','searchbox',implode(chr(10),$htmlCode));
		}
		 ...
		 * 
		 * @param		$pointer			The pointer variable in piVars
		 * @param		$count				The SQL count ressource in PI internal variables
		 * @param		$maxResults			The max results number in PI internal variables
		 * @param		$maxPages			The max pages number in PI internal variables
		 * @return		A browse box
		 * @see			fe_makeStyledContent
		 */
		function fe_buildBrowseBox($pointer='pointer',$count='res_count',$maxResults='results_at_a_time',$maxPages='maxPages') {
			...
			// Results number
			$htmlCode[] = $this->fe_makeStyledContent('div','results',sprintf($this->pObj->pi_getLL('browsebox.results'),$rN1,$rN2,$PI_count));
			...
			if ($PI_totalPages > 1) {
				...
				// Start list
				$htmlCode[] = $this->fe_makeStyledContent('ul','pages',false,1,0,1);
				
				// Check pointer
				if ($PI_pointer > 0) {
					
					// Previous link
					$prevLink = $this->pObj->pi_linkTP_keepPIvars($this->pObj->pi_getLL('browsebox.previous'),array($pointer=>$PI_pointer - 1));
					
					// Add next link
					$htmlCode[] = $this->fe_makeStyledContent('li','previous',$prevLink);
				}
				...
				for ($i = 0; $i < $showPages; $i++) {
					...
					// Page link
					$pageLink = $this->pObj->pi_linkTP_keepPIvars(sprintf($this->pObj->pi_getLL('browsebox.page'),$i + 1),array($pointer=>$i));
					
					// Add list item
					$htmlCode[] = $this->fe_makeStyledContent('li',$class,$pageLink);
				}
				...
				if ($PI_pointer < $PI_totalPages - 1) {
					...
					// Next link
					$nextLink = $this->pObj->pi_linkTP_keepPIvars($this->pObj->pi_getLL('browsebox.next'),array($pointer=>$PI_pointer + 1));
					
					// Add next link
					$htmlCode[] = $this->fe_makeStyledContent('li','next',$nextLink);
				}
			...
			// Return code
			return  $this->fe_makeStyledContent('div','browsebox',implode(chr(10),$htmlCode));
		}
		 ...
		 * 
		 * @param		$actions			The action(s) to produce, as a comma list (can be 'show', 'edit' or 'delete' at the moment).
		...
		function be_buildRecordIcons($actions,$table,$uid) {
			...
			$icons = array(
				'show' => array(
					'file' => 'gfx/zoom2.gif',
					'link' => '<a href="#" onclick="top.launchView(\'' . $table . '\', \'' . $uid . '\'); return false;">',
				),
				'edit' => array(
					'file' => 'gfx/edit2.gif',
					'link' => '<a href="#" onclick="javascript:' . htmlspecialchars(t3lib_BEfunc::editOnClick($linkParams['edit'],$GLOBALS['BACK_PATH'])) . '">',
				),
				'delete' => array(
					'file' => 'gfx/garbage.gif',
					'link' => '<a href="' . htmlspecialchars($GLOBALS['SOBE']->doc->issueCommand($linkParams['delete'])) . '" onclick="' . htmlspecialchars('return confirm(\'' . 1 . '\');') . '">',
				),
			);
			...
			foreach($actionsArray as $icon) {
				...
				if (array_key_exists($icon,$icons)) {
					...
					$htmlCode[] =  $icons[$icon]['link'] . '<img ' . t3lib_iconWorks::skinImg($GLOBALS['BACK_PATH'],$icons[$icon]['file'],'') . ' alt="" hspace="0" vspace="0" border="0" align="middle"></a>';
				}
			}
		 ...
		 * @param		$treeStartingPoint	The starting point for the page tree
		 * @param		$size				The size of the select
		 * @param		$multiple			Allow multiple selection
		 * @param		$pageIcons			Render page icons in option tags
		 * @return		A select menu with the page tree
		 */
		function be_buildPageTreeSelect($name,$treeStartingPoint=0,$size='1',$multiple=false,$pageIcons=1) {
			
			// Function ID
			$funcId = 'be_buildPageTreeSelect';
			...
			// Start select
			$htmlCode[] = '<select name="' . $name . '" size="' . $size . '"' . $multiple . '>';
			...
			foreach($tree->tree as $page) {
				...
				if ($pageIcons) {
					...
					// Style parameter
					$styleParam = ' style="' . tx_apimacmade::be_getSelectStyleRecordIcon('pages',$page['row'],$GLOBALS['BACK_PATH']) . '"';
				}
				
				// Option
				$htmlCode[] = '<option value="' . $page['row']['uid'] . '"' . $styleParam . '>' . $indent . $page['row']['title'] . '</option>';
			}
		 ...
		 * @param		$rec				The record row (array)
		 * @param		$backPath			The back path to typo3 (usually $GLOBALS['BACK_PATH'])
		 * @return		CSS styles ready to be included in a style parameter
		 */
		function be_getSelectStyleRecordIcon($table,$rec,$backPath) {
			
			// Function ID
			$funcId = 'be_getSelectStyleRecordIcon';
			...
			// Style parameter
			$style = 'background: url(' . $skinIcon . '); background-repeat: no-repeat; padding-top: ' . $padTop . '; padding-left: ' . ($infos[0] + 1) . '; height: ' . $height . ';';
		 ...
		 * 
		 * @param		$table				The table of the record
		 * @param		$rec				The record's row
		 * @param		$backPath			The back path to typo3 (usually $GLOBALS['BACK_PATH']).
		 * @param		$align				The align parameter of the IMG tag
		 * @return		The icon with CSM menu
		 */
		function be_getRecordCSMIcon($table,$rec,$backPath,$align='top') {
			
			// Function ID
			$funcId = 'be_getRecordCSMIcon';
			
			// Get record icon
			$icon = t3lib_iconWorks::getIconImage($table,$rec,$backPath);
			
			// Return icon with CSM
			return $this->pObj->doc->wrapClickMenuOnIcon($icon,$table,$rec['uid'],1);
		}
		 ...
		 * @param		$fieldList			The list of fields to select from the table
		 * @param		$whereClause		Optional WHERE clauses put in the end of the query, if none, supply blank string
		 * @param		$groupBy			Optional GROUP BY field(s), if none, supply blank string
		 * @param		$orderBy			Optional ORDER BY field(s), if none, supply blank string.
		 * @param		$limit				Optional LIMIT value ([begin,]max), if none, supply blank string
		 * @param		$sepField			The ASCII separator character for each field
		 * @param		$sepRow				The ASCII separator character for each row
		 * @param		$directOut			Output the generated file directly as a text file
		 * @param		$directOutCharset	The charset for the output file
		 * @return		The formatted database table contents
		 */
		function db_table2text($table,$fieldList='*',$whereClause='',$groupBy='',$orderBy='',$limit='',$sepField=9,$sepRow=10,$directOut=0,$directOutCharset='iso-8859-1') {
			...
			// Function ID
			$funcId = 'db_table2text';
			
			// Output storage
			$output = array();
			
			// MySQL ressource
			$res = $GLOBALS['TYPO3_DB']->exec_SELECTquery($fieldList,$table,$whereClause,$groupBy,$orderBy,$limit);
			...
			if ($directOut) {
				...
				// Output content
				tx_apimacmade::div_output($content,'text/plain','t3db_' . $table . '.txt','attachment',$directOutCharset);
		 ...
		 * @param		$orderBy			Optional ORDER BY field(s), if none, supply blank string
		 * @param		$limit				Optional LIMIT value ([begin,]max), if none, supply blank string
		 * @param		$uppercase			Use uppercase for XML tags
		 * @param		$xmlDeclaration		Insert XML declaration
		 * @param		$xmlVersion			The XML version
		 * @param		$xmlEncoding		The XML encoding
		 * @param		$directOut			Output the generated file directly as an XML file
		 * @param		$ns					The XML namespace
		 * @param		$nsPrefix			The prefix used in the XML to link elements to the namespace
		 * @return		The database table contents as XML nodes
		 * @see			div_output
		 */
		function db_table2xml($table,$fieldList='*',$whereClause='',$groupBy='',$orderBy='',$limit='',$uppercase=0,$xmlDeclaration=1,$xmlVersion='1.0',$xmlEncoding='iso-8859-1',$directOut=0,$ns=false,$nsPrefix='ns') {
			...
			if ($xmlDeclaration) {
				...
				// Add XML declaration
				$output[] = '<?xml version="' . $xmlVersion . '" encoding="' . $xmlEncoding . '"?' . '>';
			}
			...
			while($row = $GLOBALS['TYPO3_DB']->sql_fetch_assoc($res)) {
				...
				// Begin row node
				$output[] = chr(9) . '<' . $nsPrefix . 'record' . ' n="' . $rowCount . '">';
				...
				foreach($row as $key=>$value) {
					...
					// Begin table node
					$output[] = chr(9) . chr(9) . chr(9) . '<' . $name . '>' . $value . '</' . $name . '>';
				}
				
				// End table node
				$output[] = chr(9) . '</' . $nsPrefix . 'record>';
			}
			...
			if ($directOut) {
				...
				// Output content
				tx_apimacmade::div_output($content,'text/xml','t3db_' . $table . '.xml','attachment',$xmlEncoding);
		 ...
		 * @return		An ISO-8859-1 string.
		 */
		function div_utf8ToIso($content) {
			
			// Function ID
			$funcId = 'div_utf8ToIso';
		 ...
		 * SPECIAL NOTE: This function can be called without the API class instantiated.
		 * 
		 * @param		$tstamp				The base timestamp
		 * @param		$currentTime		The time from which to calculate the age (timestamp). Will use current time if none supplied
		 * @param		$ageType			The type of age to return (seconds, minutes, hours, or days)
		 * @return		An age, as a numeric value
		 */
		 ...
		 * SPECIAL NOTE: This function can be called without the API class instantiated.
		 * 
		 * @param		$vars				An array with the variables to check
		 * @param		$type				The type of the variables to check for
		 * @return		True if every variable in the input array correspond to the given type
		 * @see			div_isType
		 */
		function div_checkVarType($vars,$type='array') {
			
			// FunctionId
			$funcId = 'div_checkVarType';
		 ...
		 * @param		$keys				A comma list of the keys to remove or keep in the input array
		 * @param		$inverse			If reverse is set, the function will keep only the keys supplied in the array. Otherwise, it will remove them.
		 * @return		A cleaned array
		 */
		function div_cleanArray($input,$keys,$inverse=0) {
			
			// Function ID
			$funcId = 'div_cleanArray';
		 ...
		 * @param		$http				If set, add http:// before the base URL
		 * @param		$trailingSlash		If set, add a slash after the base URL
		 * @return		A base URL
		 */
		 ...
		 * @param		$charset			An optionnal charset to use for the properties
		 * @return		The vCard content, ready for output
		 */
		function div_vCardCreate($user,$version='3.0',$charset=false) {
			
			// Function ID
			$funcId = 'div_vCardCreate';
			...
			if (is_array($user)) {
				...
				$vCard[] = 'N' . $charset . ':' . $user['name'] . ';' . $user['firstname'] . ';;;';
				$vCard[] = 'NICKNAME' . $charset . ':' . $user['username'];
				$vCard[] = 'ORG' . $charset . ':' . $user['company'] . ';' . $user['department'];
				$vCard[] = 'TITLE' . $charset . ':' . $user['title'];
				$vCard[] = 'URL:' . $user['www'];
				$vCard[] = 'BDAY;value=date:' . date('Y-m-d',$user['birthday']);
				$vCard[] = 'NOTE' . $charset . ':' . $user['note'];
					...
					foreach ($user['email'] as $email) {
						...
						if (is_array($email)) {
							...
							if ($email['type'] == 'WORK' || $email['type'] == 'HOME') {
								...
								// Add standard email
								$vCard[] = 'EMAIL;type=INTERNET;type=' . $email['type'] . ':' . $email['mail'];
								
							} else {
								
								// Add custom email
								$vCard[] = 'item' . $items . '.EMAIL;type=INTERNET:' . $email['mail'];
								$vCard[] = 'item' . $items . '.X-ABLabel:_$!<Other>!$_';
					...
					foreach ($user['messenger'] as $messenger) {
						...
						if (is_array($messenger)) {
							...
							if ($messenger['type'] == 'WORK' || $messenger['type'] == 'HOME') {
								...
								$vCard[] = 'X-' . $messenger['service'] . ';type=' . $messenger['type'] . ':' . $messenger['name'];
								
							} else {
								
								// Add custom messenger
								$vCard[] = 'item' . $items . '.X-' . $messenger['service'] . ':' . $messenger['mail'];
								$vCard[] = 'item' . $items . '.X-ABLabel:_$!<Other>!$_';
					...
					foreach ($user['address'] as $address) {
						...
						if (is_array($address)) {
							...
							if ($address['type'] == 'WORK' || $address['type'] == 'HOME') {
								...
								$vCard[] = 'item' . $items . '.ADR' . $charset . ';type=' . $address['type'] . ':;;' . $address['street'] . ';' . $address['city'] . ';' . $address['state'] . ';' . $address['zip'] . ';' . $address['country'];
								
							} else {
								
								// Add custom address
								$vCard[] = 'item' . $items . '.ADR' . $charset . ';type=HOME:;;' . $address['street'] . ';' . $address['city'] . ';' . $address['state'] . ';' . $address['zip'] . ';' . $address['country'];
								$vCard[] = 'item' . $items . '.X-ABLabel:_$!<Other>!$_';
							}
							
							// Fixed fields
							$vCard[] = 'item' . $items . '.X-ABADR:us';
				...
				if (is_array($user['phone']) && count($user['phone'])) {
					...
					foreach ($user['phone'] as $phone) {
						...
						if (is_array($phone)) {
							...
							// Check type
							if ($phone['type'] == 'WORK' || $phone['type'] == 'HOME' || $phone['type'] == 'CELL' || $phone['type'] == 'MAIN' || $phone['type'] == 'PAGER') {
								
								// Add standard number
								$vCard[] = 'TEL;type=' . $phone['type'] . ':' . $phone['number'];
								
							} else if ($phone['type'] == 'WORKFAX' || $phone['type'] == 'HOMEFAX') {
								
								// Add fax number
								$vCard[] = 'TEL;type=' . substr($phone['type'],0,4) . ';type=FAX:' . $phone['number'];
								
							} else {
								
								// Add custom number
								$vCard[] = 'item' . $items . '.TEL:' . $phone['number'];
								$vCard[] = 'item' . $items . '.X-ABLabel:_$!<Other>!$_';
				...
				if ($user['iscompany']) {
					...
					// FN as user
					$vCard[] = 'FN' . $charset . ':' . $user['firstname'] . ' ' . $user['name'];
				}
		 ...
		 * @return		An array containing all the vCard(s) informations
		 */
		function div_vCardFileParse($file) {
			
			// Function ID
			$funcId = 'div_vCardFileParse';
			...
			if ($fp = @fopen($file,'r')) {
				...
				$content = tx_apimacmade::div_convertLineBreaks(fread($fp,filesize($file)));
				...
				foreach($lines as $ln) {
					...
					if ($col = strpos($ln,':')) {
						...
						if ($key == 'BEGIN' && strtoupper($val) == 'VCARD') {
						...
						} else if ($start && $key == 'END' && strtoupper($val) == 'VCARD') {
							...
							switch($key_parts[0]) {
								...
								case 'EMAIL':
									...
									} else if (in_array('TYPE=HOME',$key_parts)) {
								...
								case 'TEL':
									...
									} else if (in_array('TYPE=HOME',$key_parts) && in_array('TYPE=FAX',$key_parts)) {
										
										// Add type
										$tmp['phone'][$phoneKey]['type'] = 'HOMEFAX';
										
									} else if (in_array('TYPE=WORK',$key_parts) && in_array('TYPE=FAX',$key_parts)) {
									...
									} else if (in_array('TYPE=CELL',$key_parts)) {
										
										// Add type
										$tmp['phone'][$phoneKey]['type'] = 'CELL';
										
									} else if (in_array('TYPE=MAIN',$key_parts)) {
										
										// Add type
										$tmp['phone'][$phoneKey]['type'] = 'MAIN';
										
									} else if (in_array('TYPE=PAGER',$key_parts)) {
								...
								case 'X-AIM':
									...
									$tmp['messenger'][$messengerKey]['service'] = 'AIM';
								...
								case 'X-JABBER':
									...
									// Add values
									$tmp['messenger'][$messengerKey]['name'] = $val_parts[0];
									$tmp['messenger'][$messengerKey]['service'] = 'JABBER';
								...
								case 'X-MSN':
									...
									// Add values
									$tmp['messenger'][$messengerKey]['name'] = $val_parts[0];
									$tmp['messenger'][$messengerKey]['service'] = 'MSN';
								...
								case 'X-YAHOO':
									...
									// Add values
									$tmp['messenger'][$messengerKey]['name'] = $val_parts[0];
									$tmp['messenger'][$messengerKey]['service'] = 'YAHOO';
								...
								case 'X-ICQ':
									...
									// Add values
									$tmp['messenger'][$messengerKey]['name'] = $val_parts[0];
									$tmp['messenger'][$messengerKey]['service'] = 'ICQ';
		 ...
		 * @param		$sep				The separator used to get list items
		 * @param		$htmlspecialchars	Pass the item through htmlspecialchars()
		 * @param		$listType			The type of list to produce (UL, OL)
		 * @param		$listParams			The parameters of the list tag as key/value pairs
		 * @param		$itemsParams		The parameters of the list items tag as key/value pairs
		 * @return		An HTML list
		 * @see			div_writeTagParams
		 */
		function div_str2list($string,$sep=',',$htmlspecialchars=1,$listType='ul',$listParams=array(),$itemsParams=array()) {
			...
			// Start list
			$listCode[] = '<' . $listType . ' ' . tx_apimacmade::div_writeTagParams($listParams) . '>';
			...
			foreach($listItems as $val) {
				...
				// Write list item
				$listCode[] = '<li ' . tx_apimacmade::div_writeTagParams($itemsParams) . '>' . $item . '</li>';
			}
		 ...
		 * SPECIAL NOTE: This function can be called without the API class instantiated.
		 * 
		 * @param		$out				The content to output
		 * @param		$cType				The content type
		 * @param		$fName				The name of the file to output
		 * @param		$cDisp				The content disposition
		...
		function div_output($out,$cType,$fName,$cDisp='attachment',$charset='utf-8') {
			...
			header('Content-Disposition: ' . $cDisp . '; filename="' . $fName . '"');
						...
						if (is_array($tagValue)) {
							...
							if (count($tagValue)) {
								...
								if (array_key_exists('xml-value',$tagValue)) {
									...
									// Process sub arrays
									$elValue = chr($newLine) . tx_apimacmade::div_array2xml($tagValue,$xmlRoot,$prefix,$numeric,$numericAsAttribute,$addArrayAttribute,$xmlDeclaration,$encoding,$version,$standalone,$doctype,$newLine,$indent,$level + 1) . chr($newLine) . $codeIndents;
								}
		 ...
		 * @param		$endString			The string to add after the cropped string
		 * @param		$crop2space			Don't crop in a middle of a word
		 * @param		$stripTags			Remove all HTML tags from the string
		 ...
		 * @param		$round				Round final values
		 * @return		An array with HSL color values
		 ...
		 * @param		$L					The luminance value (0-100)
		 * @param		$round				Round final values
		 * @return		An array with RGB color values
		 * @see			div_numberInRange
		 */
		 ...
		 * @param		$B					The blue value (0-255)
		 * @param		$round				Round final values
		 * @return		An array with HSV color values
		 * @see			div_numberInRange
		 */
		...
		function div_hsl2hsv($H,$S,$L,$round=1) {
			...
			// Convert HSL to RGB
			$rgbColors = tx_apimacmade::div_hsl2rgb($H,$S,$L,$round);
			
			// Convert RGB to HSV
			return tx_apimacmade::div_rgb2hsv($rgbColors['R'],$rgbColors['G'],$rgbColors['B'],$round);
		}
		...
		function div_hsv2hsl($H,$S,$V,$round=1) {
			...
			// Convert HSV to RGB
			$rgbColors = tx_apimacmade::div_hsv2rgb($H,$S,$V,$round);
			
			// Convert RGB to HSL
			return tx_apimacmade::div_rgb2hsl($rgbColors['R'],$rgbColors['G'],$rgbColors['B'],$round);
		}
		 ...
		 * SPECIAL NOTE: This function can be called without the API class instantiated.
		 * 
		 * @param		$v1					The first value (red or hue, depending of the method)
		 * @param		$v2					The second value (green or saturation, depending of the method)
		 * @param		$v3					The third value (blue, luminosity or value, depending of the method)
		 * @param		$method				The method to use for the color creation. Can be 'RGB', 'HSL' or 'HSV'
		 * @param		$uppercase			Return value in uppercase
		 ...
		 * SPECIAL NOTE: This function can be called without the API class instantiated.
		 * 
		 * @param		$color				The original color (hexadecimal)
		 * @param		$v1					The first value (red or hue, depending of the method)
		 * @param		$v2					The second value (green or saturation, depending of the method)
		 * @param		$v3					The third value (blue, luminosity or value, depending of the method)
		 * @param		$method				The method to use for the color modification. Can be 'RGB','HSL' or 'HSV'
		 * @param		$uppercase			Return value in uppercase
		 * @return		The hexadecimal value of the modified color
		 * @see			div_rgb2hsl
		 * @see			div_rgb2hsv
		...
		function div_modifyHexColor($color,$v1,$v2,$v3,$method='RGB',$uppercase=1) {
			...
			if ($method == 'HSL') {
				...
				return tx_apimacmade::div_createHexColor($colors['H'] + $v1,$colors['S'] + $v2,$colors['L'] + $v3,'HSL',$uppercase);
				...
				// Create modified color
				return tx_apimacmade::div_createHexColor($colors['H'] + $v1,$colors['S'] + $v2,$colors['V'] + $v3,'HSV',$uppercase);
				
			} else {
				
				// Create modified color
				return tx_apimacmade::div_createHexColor($R + $v1,$G + $v2,$B + $v3,'RGB',$uppercase);
			}
		}
		...
		function div_formatXHTML($xhtml,$uppercase=0,$newLine=10,$indent=9,$level=0) {
			...
			if (is_array($xhtml)) {
				...
				foreach($xhtml as $key=>$value) {
					...
					if (is_array($value)) {
						...
						if ($value['xml-attribs']) {
							...
							$tagAttribs = ' ' . tx_apimacmade::div_writeTagParams($value['xml-attribs']);
						...
						if (!$value) {
							...
							$code[] = $codeIndents . '<' . $tagName . $tagAttribs . '>';
							$code[] = tx_apimacmade::div_formatXHTML($value,$uppercase,$newLine,$indent,$level + 1);
				...
				if (is_array($htmlArray)) {
					...
					return tx_apimacmade::div_formatXHTML($htmlArray['xml-root'],$uppercase,$newLine,$indent,0);
		...
		function div_convertLineBreaks($text,$stripNull=1) {
			...
			$text = str_replace(chr(10) . chr(13),chr(10),$text);
		...
		* @return		Boolean
		 ...
		 * SPECIAL NOTE: This function can be called without the API class instantiated.
		 * 
		 * @param		$path				The path of the directory (absolute)
		 * @param		$relative			Path is relative to the Typo3 site, otherwise absolute
		 * @param		$cleaned			Internal only! File cleaning has been processed
		 * @return		Boolean
		 */
			...
			if (!$cleaned) {
				...
				if (t3lib_div::validPathStr($path)) {
					...
					if (t3lib_div::isAbsPath($path) && t3lib_div::isAllowedAbsPath($path)) {
						...
						if (@file_exists($path) && @is_writeable($path)) {
							...
							// Get all sub files
							$sub = t3lib_div::getAllFilesAndFoldersInPath(array(),$path);
				...
				if (is_array($directories) && count($directories)) {
					...
					foreach($directories as $subdir) {
						...
						$subDeleted = tx_apimacmade::div_rmdir($path . $subdir . '/',0,1);
					}
				}
			...
			if (empty($variable)) {
				...
				switch($variableType) {
					...
					case 'array':
						...
						// View array
						echo(tx_apimacmade::viewArray($variable));
